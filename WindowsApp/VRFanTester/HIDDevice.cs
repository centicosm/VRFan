/*  The code in this file is from Ashley Deakin's tutorial on developing HID devices for C#
...
namespace VRFanTester {
    ...
    public abstract class HIDDevice : Win32Usb, IDisposable
    {
		...
		private void Initialise(string strPath)
		{
            ...
            //SafeFileHandle h = CreateFile(strPath, GENERIC_READ | GENERIC_WRITE, 0, IntPtr.Zero, OPEN_EXISTING, FILE_FLAG_OVERLAPPED, IntPtr.Zero);
